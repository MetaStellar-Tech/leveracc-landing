    ...
    <footer className="relative px-4 md:px-8 max-w-7xl mx-auto w-full">
      ...
      <div className="relative rounded-[40px] py-16 px-6 md:px-12 md:py-20 text-center overflow-visible mb-12 isolate">
        ...
        <div className="absolute inset-0 -z-10 overflow-hidden rounded-[40px]">
          ...
          <div
            className="absolute inset-0 opacity-[0.07] mix-blend-overlay pointer-events-none rounded-[40px]"
            style={{
              backgroundImage:
        ...
        <div className="absolute bottom-0 right-0 z-10 pointer-events-none hidden md:block">
          <Image
            ...
            width={217}
            height={259}
            className="size-70 object-bottom-right object-contain rounded-br-[80px] translate-x-3"
          />
        </div>
        {/* Content */}
      ...
      <div className="flex flex-col md:flex-row justify-between items-center py-8 gap-6 text-gray-500 dark:text-gray-400 text-xs md:text-sm border-t border-gray-200/50 dark:border-gray-700/50 relative">
        <div className="font-leveracc flex items-center gap-2 text-base md:text-lg text-black dark:text-white">
          <Image
        ...
        <div className="flex flex-col md:flex-row items-center gap-6">
          ...
          <div className="hidden md:block w-px h-4 bg-gray-300 dark:bg-gray-700 mx-2">
          </div>
