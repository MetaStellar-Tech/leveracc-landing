    ...
    <div className="w-full">
      ...
      <div className="text-center mb-16 px-4">
        ...
        <p className="text-xl text-gray-500 max-w-3xl mx-auto leading-relaxed">
          See how LeverAcc transforms your position size while maintaining the same initial capital requirement.
        </p>
      </div>
      ...
      <div className="bg-[#0c111d] rounded-3xl shadow-2xl overflow-hidden border border-gray-800 font-sans text-gray-300">
        ...
        <div className="flex flex-col lg:flex-row min-h-[550px]">
          ...
          <div className="flex-1 p-8 md:p-12 relative border-r border-gray-800/50 flex flex-col">
            <h2 className="text-3xl text-white font-normal mb-2 tracking-tight">Notional Exposure</h2>
            <p className="text-gray-500 mb-8 font-light">Comparing buying power output based on identical inputs.</p>
            ...
            <div className="flex-1 w-full md:w-[90%] mx-auto relative mt-12 min-h-[350px]">
              ...
              <div className="absolute inset-0 bottom-14 z-0 pointer-events-none">
                ...
                {[100, 75, 50, 25, 0].map((val, i) => (
                  <div key={i} className="flex items-center absolute w-full" style={{ top: `${(i) * 25}%` }}>
              ...
              <div className="absolute inset-0 bottom-14 z-10 pl-12 flex justify-around items-end">
                ...
                <div className="relative w-24 h-full flex items-end justify-center group">
                  <span className="absolute bottom-[20%] mb-3 text-white font-medium text-lg transition-transform group-hover:-translate-y-1">$20,000</span>
                  {/* Height is 20% relative to 100k max */}
                  <div className="w-full bg-gradient-to-b from-gray-600 to-gray-800/40 rounded-t-sm h-[20%] relative group-hover:opacity-90 transition-opacity"></div>
                </div>

                {/* Bar 2: Trade on LeverAcc */}
                <div className="relative w-24 h-full flex items-end justify-center group">
                  <span className="absolute bottom-[100%] mb-3 text-white font-medium text-lg transition-transform group-hover:-translate-y-1">$100,000</span>
                  {/* Height is 100% relative to 100k max */}
                  <div className="w-full bg-[#0099ff] rounded-t-sm h-[100%] shadow-[0_0_40px_rgba(0,153,255,0.25)] relative">
              ...
              <div className="absolute bottom-0 left-0 right-0 pl-12 flex justify-around h-14 items-center pt-4">
                 <span className="text-gray-500 text-sm font-medium min-w-[140px] text-center whitespace-nowrap">Trade on Perp DEX</span>
                 <span className="text-gray-400 text-sm font-medium min-w-[140px] text-center whitespace-nowrap">Trade on LeverAcc</span>
              </div>
          ...
          <div className="lg:w-[420px] bg-[#0f1522] p-8 md:p-12 flex flex-col justify-center border-t lg:border-t-0 border-gray-800/50">
            ...
            <div className="mb-10 relative">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="text-white text-lg font-normal">Trade on Perp DEX</h3>
              </div>
              <div className="pl-6 border-l border-gray-800 ml-1.5 py-1">
                <div className="text-[10px] text-gray-500 uppercase tracking-wider mb-1 font-medium">Formula</div>
                <div className="text-xl text-gray-300 font-light">
                  <span className="text-gray-500">$1k</span> × 20x = <span className="text-white font-medium">$20k</span>
                </div>
              </div>
            </div>
            ...
            <div className="mb-12 relative">
              ...
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="text-white text-lg font-medium">Trade on LeverAcc</h3>
              </div>
              
              <div className="pl-6 border-l border-blue-900/30 ml-1.5 py-1">
                <div className="text-[10px] text-gray-500 uppercase tracking-wider mb-2 font-medium">The Pre-Fund Effect</div>
                <p className="text-sm text-gray-400 mb-4 leading-relaxed">
                  Your $1k collateral is boosted by <span className="text-[#0099ff] font-medium">$4k liquidity injection</span> before execution.
                </p>
                
                <div className="text-[10px] text-gray-500 uppercase tracking-wider mb-1 font-medium">Formula</div>
                <div className="text-xl text-gray-300 font-light">
                  (<span className="text-[#0099ff] font-medium">$1k + $4k</span>) × 20x = <span className="text-white font-medium">$100k</span>
                </div>
              </div>
            </div>
